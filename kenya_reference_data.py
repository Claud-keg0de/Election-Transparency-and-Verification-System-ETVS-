...
# Historical 2022 IEBC prison polling-station reference data.
# Source: IEBC 21 June 2022 Kenya Gazette, "Registered Voters per Prison".
# The Gazette contains 106 polling-station rows totaling 7,483 voters. An IEBC
# polling-day press update separately referred to 103 polling stations; ETVS
# preserves that source discrepancy rather than silently changing either value.
PRISON_STATIONS_2022 = (
    ("001", "Shimo La Tewa Main", 375),
    ("002", "Shimo La Tewa Women", 10),
    ("003", "Shimo La Tewa Medium", 30),
    ("005", "Kingorani Prison (B)", 34),
    ("006", "Kwale Main Prison (B)", 59),
    ("007", "Kwale Women", 4),
    ("008", "Kilifi Prison", 48),
    ("009", "Kaloleni", 25),
    ("010", "Malindi Prison (B)", 154),
    ("011", "Malindi Women", 13),
    ("012", "Hola Prison", 14),
    ("013", "Hindi Prison", 15),
    ("014", "Taveta Prison", 31),
    ("015", "Wundanyi", 39),
    ("016", "Voi Remand Prison", 40),
    ("017", "Manyani", 189),
    ("018", "Garissa Main", 40),
    ("020", "Wajir", 9),
    ("021", "Mandera", 4),
    ("022", "Moyale Prison", 6),
    ("023", "Marsabit Prison", 26),
    ("024", "Isiolo Prison", 31),
    ("025", "Kangeta Prison", 37),
    ("026", "Meru Main", 360),
    ("027", "Meru Women", 22),
    ("028", "Uruku Prison", 15),
    ("030", "Chuka", 34),
    ("032", "Embu Main", 349),
    ("033", "Embu Women", 33),
    ("034", "Mwingi Prison", 52),
    ("035", "Kitui Women", 1),
    ("036", "Kitui Prison (B)", 22),
    ("038", "Yatta Prison (B)", 49),
    ("039", "Machakos Main", 67),
    ("040", "Machakos Women", 10),
    ("041", "Makueni Prison (B)", 115),
    ("042", "Nyandarua Prison", 52),
    ("043", "Nyeri Main", 276),
    ("044", "Nyeri Women", 17),
    ("045", "Nyeri Medium", 75),
    ("046", "Mwea Prison", 74),
    ("047", "Kerugoya Prison", 62),
    ("048", "Muranga Prision", 71),
    ("049", "Muranga Women", 5),
    ("050", "Muranjau Prison", 22),
    ("051", "Thika Main Prison", 14),
    ("052", "Thika Women Prison", 5),
    ("053", "Ruiru Prison", 51),
    ("054", "Kiambu Prison", 90),
    ("056", "Kapenguria", 16),
    ("057", "Maralal", 38),
    ("058", "Kitale Medium", 21),
    ("059", "Kitale Annex", 36),
    ("060", "Kitale Women", 16),
    ("061", "Kitale Main Prison (B)", 176),
    ("062", "Eldoret Women", 5),
    ("063", "Eldoret Main", 124),
    ("064", "Ngeria Farm", 50),
    ("065", "Tambach Prison", 20),
    ("066", "Kapsabet Prison", 105),
    ("067", "Kabarnet Prison", 29),
    ("068", "Eldama Ravine Prison", 25),
    ("069", "Rumuruti", 36),
    ("070", "T/Fall Prison", 76),
    ("071", "T/Fall Women", 9),
    ("072", "Nanyuki Prison", 140),
    ("073", "Naivasha Main", 390),
    ("074", "Naivasha Medium", 75),
    ("075", "Naivasha Women", 13),
    ("076", "Nakuru Main", 171),
    ("077", "Nakuru Women", 10),
    ("078", "Narok Prison", 56),
    ("079", "Kajiado Prison", 43),
    ("080", "Athir River Prison", 70),
    ("082", "Kericho Main", 46),
    ("084", "Kericho Annex", 13),
    ("085", "Sotik Prison", 17),
    ("086", "Bomet Prison", 21),
    ("087", "Kakamega Main", 135),
    ("088", "Kakamega Women", 8),
    ("089", "Shikusa Farm", 15),
    ("091", "Vihiga Prison", 20),
    ("092", "Bungoma Prison (B)", 14),
    ("093", "Busia Women Wing", 1),
    ("094", "Busia Prison", 61),
    ("095", "Siaya Prison (B)", 7),
    ("096", "Kisumu Main", 494),
    ("097", "Kisumu Women", 22),
    ("098", "Kisumu Medium", 132),
    ("099", "Kibos Main Prison (B)", 79),
    ("100", "Kibos Medium Prison (B)", 15),
    ("102", "Homa Bay Prison", 40),
    ("103", "Migori Women", 6),
    ("104", "Migori Prison (B)", 24),
    ("105", "Kehancha Prison/Kendege", 4),
    ("106", "Kisii Main", 92),
    ("107", "Kisii Women", 9),
    ("109", "Nairobi West", 91),
    ("110", "Langata Women Prison", 130),
    ("112", "Kamiti Medium Prison", 215),
    ("113", "Kamiti Main Prison", 362),
    ("113", "Kamiti Main Prison", 362),
    ("116", "Nairobi Remand/Allocation", 81),
    ("118", "Kilgoris Prison", 12),
    ("119", "Loitokitok Gk Prison", 3),
    ("121", "Lodwar Gk Prison", 26),
)

if len(PRISON_STATIONS_2022) != 106:
    raise RuntimeError(f"Expected 106 2022 Gazette prison polling-station rows, got {len(PRISON_STATIONS_2022)}")
if sum(voters for _, _, voters in PRISON_STATIONS_2022) != 7483:
    raise RuntimeError("2022 prison station voters must total 7,483")
